...
<div id="div2" align="center">
    ...
    <p><a id="id1" href="${pageContext.request.contextPath}/user/allinfor/userid=${userid}&p=1">全部维修单</a>&nbsp;&nbsp;&nbsp;
        ...
        <a href="javascript:void(0)">待维修</a>&nbsp;&nbsp;&nbsp;
...
<div align="center"  id="div1">
    ...
    <c:if test="${message.flag==1}">
        ...
        <a href="${pageContext.request.contextPath}/user/infor_wait?userid=${page.list[0].userid}&p=${page.firstPage}">第一页</a>
        <c:if test="${page.nextPage==0}">
            <a href="javascript:void(0)">下一页</a>
        </c:if>
        <c:if test="${page.nextPage!=0}">
            <a href="${pageContext.request.contextPath}/user/infor_wait?userid=${page.list[0].userid}&p=${page.nextPage}">下一页</a>
        </c:if>
        <c:if test="${page.prePage==0}">
            <a href="javascript:void(0)">上一页</a>
        </c:if>
        <c:if test="${page.prePage!=0}">
            <a href="${pageContext.request.contextPath}/user/infor_wait?userid=${page.list[0].userid}&p=${page.prePage}">上一页</a>
        </c:if>
        <a href="${pageContext.request.contextPath}/user/infor_wait?userid=${page.list[0].userid}&p=${page.lastPage}">最后页</a>
    </c:if>
</div    >
</body>
</html>
